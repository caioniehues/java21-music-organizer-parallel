...
REM Set application directory (parent of scripts folder)
set APP_DIR=%~dp0..
cd /d "%APP_DIR%"
...
REM Application JAR file (use the fat jar with dependencies)
set APP_JAR=target\music-organizer-1.0-SNAPSHOT-jar-with-dependencies.jar
