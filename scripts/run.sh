...
# Script directory (get parent directory since scripts are in scripts/ folder)
...
main() {
    ...
    # Application JAR file (use the fat jar with dependencies)
    APP_JAR="target/music-organizer-1.0-SNAPSHOT-jar-with-dependencies.jar"
